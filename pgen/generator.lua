...
local collect_cg_names = common.collect_cg_names
local collect_constants = common.collect_constants
local collect_cmt_codes = common.collect_cmt_codes
local collect_indenters = common.collect_indenters
