  ...
  { // FIRST-byte dispatched ordered choice
    ...
    if (parser->pos < parser->input_len) {
      ...
      case 55:
        ...
        break;
      case 56:
        pgen_dispatch_mask = 0x0000000000000200ULL;
        break;
      case 57:
  ...
  { // Sequence with 2 patterns
    ...
    if (parser->success) {
      { // Constant Capture
        ...
        pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[1], 0, 0); // "allowed"
      }
      if (!parser->success) {
        RESTORE_POSITION(parser, pos);
      }
        ...
        if (parser->success) {
          ...
          if (parser->success) {
            ...
            if (parser->success) {
              { // Constant Capture
                // A constant capture matches the empty string and produces all given values
                pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[3], 0, 0); // "clean"
              }
            }
          }
        }
  ...
  {   // Choice
    { // Sequence with 2 patterns
      ...
      { // Match-time capture (Cmt id=0)
        ...
        if (parser->success) {
          pgen_run_cmt(parser, __cmt_refs[0], cmt_start_pos, cmt_cap_base, cmt_top_base);
      ...
      if (parser->success) {
        { // Constant Capture
          // A constant capture matches the empty string and produces all given values
          pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[7], 0, 0); // "never"
        }
        if (!parser->success) {
          RESTORE_POSITION(parser, pos);
        }
    ...
    if (!parser->success && !parser->throw_label) {
      ...
      { // Sequence with 2 patterns
        ...
        if (parser->success) {
          { // Constant Capture
            // A constant capture matches the empty string and produces all given values
            pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[4], 0, 0); // "cmt-clean"
          }
          if (!parser->success) {
            RESTORE_POSITION(parser, pos);
          }
      ...
      if (parser->success) {
        { // Choice
          ...
          if (!parser->success && !parser->throw_label) {
            ...
            { // Constant Capture
              // A constant capture matches the empty string and produces all given values
              pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[5], 0, 0); // "disabled"
            }
          }
        }
        if (parser->success) {
  ...
  { // Sequence with 3 patterns
    ...
    if (parser->success) {
      ...
      if (parser->success) {
        { // Constant Capture
          // A constant capture matches the empty string and produces all given values
          pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[9], 0, 0); // "pure"
        }
      }
      if (!parser->success) {
        RESTORE_POSITION(parser, pos);
      ...
      { // Sequence with 3 patterns
        ...
        if (parser->success) {
          ...
          if (parser->success) {
            { // Constant Capture
              // A constant capture matches the empty string and produces all given values
              pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[6], 0, 0); // "double"
            }
          }
          if (!parser->success) {
            RESTORE_POSITION(parser, pos);
        ...
        { // Sequence with 3 patterns
          ...
          if (parser->success) {
            ...
            if (parser->success) {
              { // Constant Capture
                // A constant capture matches the empty string and produces all given values
                pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[13], 0, 0); // "top-check"
              }
            }
            if (!parser->success) {
              RESTORE_POSITION(parser, pos);
    ...
    if (!parser->success && !parser->throw_label) {
      ...
      { // Sequence with 2 patterns
        ...
        if (parser->success) {
          { // Constant Capture
            // A constant capture matches the empty string and produces all given values
            pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[10], 0, 0); // "single"
          }
          if (!parser->success) {
            RESTORE_POSITION(parser, pos);
          }
          ...
          if (parser->success) {
            ...
            if (parser->success) {
              ...
              if (parser->success) {
                { // Constant Capture
                  // A constant capture matches the empty string and produces all given values
                  pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[0], 0, 0); // "advanced"
                }
              }
            }
          }
      ...
      if (parser->success) {
        ...
        if (parser->success) {
          ...
          if (parser->success) {
            { // Constant Capture
              // A constant capture matches the empty string and produces all given values
              pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[2], 0, 0); // "blocked"
            }
          }
        }
      }
                ...
                if (parser->success) {
                  ...
                  if (parser->success) {
                    ...
                    if (parser->success) {
                      { // Constant Capture
                        // A constant capture matches the empty string and produces all given values
                        pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[8], 0, 0); // "ok"
                      }
                    }
                  }
                }
            ...
            if (parser->success) {
              ...
              if (parser->success) {
                ...
                if (parser->success) {
                  { // Constant Capture
                    // A constant capture matches the empty string and produces all given values
                    pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[11], 0, 0); // "tab2"
                  }
                }
              }
            }
            ...
            if (parser->success) {
              ...
              if (parser->success) {
                ...
                if (parser->success) {
                  { // Constant Capture
                    // A constant capture matches the empty string and produces all given values
                    pgen_cap_push(parser, PGEN_CAP_CONST, __const_refs[12], 0, 0); // "tab4"
                  }
                }
              }
            }
...
#define PGEN_PARSER_MT "pgen.indent"
...
static int l_indent_gc(lua_State *L) {
  indent_free((Parser *)lua_touserdata(L, 1));
  return 0;
}
...
int luaopen_indent(lua_State *L) {
  if (luaL_newmetatable(L, PGEN_PARSER_MT)) {
    lua_pushcfunction(L, l_indent_gc);
